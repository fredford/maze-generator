...
class ExpectedSarsaAgentTest(unittest.TestCase):
    """
    Unit testing for the Expected Sarsa agent. Testing the agent_start, agent_step and agent_end.
    """
    def test_agent_start(self):
        ...
        test_agent = ExpectedSarsaAgent(test["num_actions"], test["num_states"], test["epsilon"], test["step_size"], test["discount"], test["seed"])
    ...
    def test_agent_end(self):
        ...
        test_q_estimate = np.array([[0., 0.1, 0., 0.],
                                    [0., 0., 0., 0.1]])
